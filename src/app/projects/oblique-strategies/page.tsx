...
export default function ObliqueStrategies() {
  ...
  const [currentStrategy, setCurrentStrategy] = useState("Over One Hundred Worthwhile Dilemmas");

  const displayStrategy = () => {
    if (availableStrategies.length === 0) {
      setCurrentStrategy("Over One Hundred Worthwhile Dilemmas");
    ...
    const newAvailable = [...availableStrategies];
